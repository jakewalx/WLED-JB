...
void FourLineDisplayUsermod::setup() {
  ...
  switch (type) {
    ...
    case SSD1351_128X128: u8x8 = (U8X8 *) new U8X8_SSD1351_128X128_4W_HW_SPI(ioPin[0], ioPin[1], ioPin[2]); break;   // Pins are CS, DC, RST
...
void FourLineDisplayUsermod::appendConfigData() {
  ...
  oappend(F("addOption(dd,'SSD1351 128x128 SPI',10);"));
